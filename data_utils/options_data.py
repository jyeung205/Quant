...
class OptionsData:
    ...
    def get_options_chain_by_strike(self, ticker, strike, type):
    ...
    def get_options_chain_by_expiry(self, ticker, expiry, type):
        asset = yf.Ticker(ticker)
    ...
    def get_options_grid(self, ticker, type):
        asset = yf.Ticker(ticker)
        expirations = asset.options
...
if __name__ == '__main__':
    ...
    o = OptionsData()
    print(o.get_options_grid('TSLA', 'c').to_string())
